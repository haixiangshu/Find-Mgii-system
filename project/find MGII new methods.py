...
def Find_peaks(normalized_flux, final_loc):
    ...
    peaks, _ = find_peaks(peakcandi, height=1.2, threshold=None, distance=(2803-2796), prominence=None, width=None, wlen=None, rel_height=None, plateau_size=None)
    return peaks
...
x_array, y_array_2gauss, parameterlist, coveriancelist, gauss_peak_list, system = double_Gaussian_profile(location1, location2, normalized_flux, wave_initial, z)
region = []
num1 = 0
cal = 0
