...
ax1.plot(x_array[146: 154], y_array_2gauss[146: 154], "r", label='raw')
ax1.plot(x_array[146: 154], gauss_peak_list[146: 154], "b", label='gaussian fitting')
...
def calcuequivalent_width(x_array, parameterlist):
    ...
    return equw
zmgii, zmgiicorrection1, zmgiicorrection2 = calcuZ(parameterlist[6*4:6*5])
