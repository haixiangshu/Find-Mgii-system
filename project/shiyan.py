...
def doubleGaussian_profile(location1, location2, flux, wavelength, z):
    """
...
m1, m2, w1, w2, c1, c2 = doubleGaussian_profile(location1, location2, flux1, wave1, z)
print(m1[1], m2[1], w1[1], w2[1], c1[1], c2[1])
#fig = plt.figure(figsize=(5, 5))
#plt.subplot(111)
#plotgauss1 = lambda xdata: plot(xdata, w1 * matplotlib.mlab.normpdf(xdata, m1, np.sqrt(c1))[0], linewidth=3)
#plotgauss2 = lambda xdata: plot(xdata, w2 * matplotlib.mlab.normpdf(xdata, m2, np.sqrt(c2))[0], linewidth=3)

#fig.savefig('gaussian_fit.pdf')
#plt.plot(wave1, flux1, label='Raw')
plt.show()
