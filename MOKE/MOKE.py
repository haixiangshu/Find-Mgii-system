...
def MOKE(normalized_flux, wave_initial, z):
    """
    ...
    for i in range(30, len(normalized_flux)):
        ...
        if i+50 < len(normalized_flux):
            ...
            Equv[i] = equ
            MOKE_data = _2gaussian(x_array, amp1, cen1, sigma1, amp2, cen2new, sigma2)
            inputflux[i-gap:I+gap] = MOKE_data
            normalized_fluxmatrix[i] = inputflux
    return normalized_fluxmatrix, Equv
normalized_flux, Equv = MOKE(normalized_flux, wave_initial, z)
#print("EquvMOCK=", Equv)
