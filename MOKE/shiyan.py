...
plt.step(wave_initial, normalized_flux[3150], label='Normalized flux')
...
plt.step(wave_initial, normalized_flux[3150], label='Normalized flux')
plt.plot(wave_initial, 1 / normalized_inv ** 0.5, label='Error')
plt.fill_between(wave_initial, 1.2, where=(wave_initial>5700)&(wave_initial<5950), color='grey', alpha=0.5)
plt.xlabel('$\lambda$ [$\AA$]')
plt.ylabel('Final Residual')
plt.xlim([3600, 10000])
plt.legend()
...
plt.figure(figsize=(12, 6))
plt.step(wave_initial, normalized_flux[1500], label='Normalized flux')
plt.plot(wave_initial, 1 / normalized_inv ** 0.5, label='Error')
plt.xlabel('$\lambda$ [$\AA$]')
plt.ylabel('Final Residual')
plt.xlim([4560, 4650])
...
plt.step(wave_initial, normalized_flux[1500], label='Normalized flux')
plt.plot(wave_initial, 1 / normalized_inv ** 0.5, label='Error')
plt.fill_between(wave_initial, 1.2, where=(wave_initial>4560)&(wave_initial<4660), color='grey', alpha=0.5)
plt.xlabel('$\lambda$ [$\AA$]')
plt.ylabel('Final Residual')
plt.xlim([3600, 10000])
plt.legend()
