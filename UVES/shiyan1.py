...
ax1.plot(xfinaldata[49453:50605], yfinaldata[49453:50605], "r", label='raw')
ax1.plot(xfinaldata[49453:50605], gauss_peak_list[49453:50605], "b", label='gaussian fitting')
...
equw = calcuequivalent_width(xfinaldata[113:125], parameterlist[6*(nset-1):6*nset])
print("equw=", equw)
print("zmgii=", zmgii)
